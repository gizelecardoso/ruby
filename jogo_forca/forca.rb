...
def escolhe_palavra_secreta
    ...
    #primeira leitura de todo o arquivo
    texto = File.read("dicionario.txt")
    #segunda leitura para tirar os \n
...
def escolhe_palavra_secreta_sem_consumir_muita_memoria
    avisa_escolhendo_palavra
    #outra maneira de ler o arquivo - new abre um arquivo para leitura, por isso que depois temos que fechar o arquivo
    arquivo = File.new("dicionario.txt")
    # a primeira linha do dicionario tem o numero de elementos do arquivo
    quantidade_de_palavras = arquivo.gets.to_i
    numero_escolhido = rand(quantidade_de_palavras)
    #iterando sobre as linhas do arquivo até a linha ref ao numero escolhido
